    ...
    return (
      <div id="containerDiv">
        <form onSubmit={this.handleSumbit}>
          ...
          <button className="button" id="divisionSign" value="/" onClick={this.handleInput}>/</button>
          <br />
          ...
          <br />
          <button className="button" id="forTestingOne" value="1" onClick={this.handleInput}>1</button>
          ...
          <button className="button" id="forTestingPlus" value="+" onClick={this.handleInput}>+</button>
          <br />
